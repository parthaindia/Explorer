...
import partha.explorer.manager.RequestManager;
 ...
 * @author Partha
 */
public class SendRequestService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Request >reqObj = new Gson().fromJson(req, new TypeToken<List<Request>>() {
            }.getType());
            String resCount = new RequestManager().sendRequest(reqObj);
            if (resCount != null) {
                out.write(new Gson().toJson(resCount));
            } else {
